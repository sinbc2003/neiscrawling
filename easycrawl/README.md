...
## 🌐 웹 UI 사용하기 (신기능! v0.2.0)

### ChatGPT/Claude 스타일의 고급스러운 웹 인터페이스

**터미널 명령어가 어렵다면** 웹 UI를 사용하세요! 브라우저에서 버튼 클릭만으로 모든 기능을 사용할 수 있습니다.
...
**일반적으로 웹 UI 사용을 권장합니다!**

자세한 내용은 [웹 UI 가이드](WEB_UI_GUIDE.md)를 참고하세요.
